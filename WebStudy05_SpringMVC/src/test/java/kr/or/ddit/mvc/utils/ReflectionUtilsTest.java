...
public class ReflectionUtilsTest {
	...
	public void testGetMethodsAtClass() {
		List<Method> methods = ReflectionUtils.getMethodsAtClass(ReflectionUtilsTest.class, 
																String.class, 
																HttpServletRequest.class, HttpServletResponse.class);
	...
	public void testGetClassesWithAnnotationAtBasePackages() {
		Map<Class<?>, Controller> classes = 
				ReflectionUtils.getClassesWithAnnotationAtBasePackages(Controller.class, basePackage);
